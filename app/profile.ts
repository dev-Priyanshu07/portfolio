...
export const profile = {
  photo: '',
  about: 'i debug code to live; chronically online on twitter; survived jee and nit. right now, i build stuff and read books.',
  aboutNote: '',
  work: [
  ...
  socials: { github: 'https://github.com/dev-Priyanshu07', linkedin: 'https://www.linkedin.com/in/priyanshu-mishra-62b349211/', email: 'mpriyanshu0000@gmail.com', twitter: '' },
  blog: '/blog',
};
